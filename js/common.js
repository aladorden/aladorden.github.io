...
// youtube
$('.play').click(function() {
	$('.mfp-iframe').attr('src', 'https://www.youtube.com/embed/9ZfN87gSjvI?enablejsapi=1&version=3&playerapiid=ytplayer')
	$(".play").css('zIndex', '0')
	$(".mfp-iframe").css('zIndex', '15')
});
...
$('.play').click(function() { setTimeout(function() {
	...
	$('.close-video').toggle();
	$('.top-line').hide();
	$('.mfp-iframe')[0].contentWindow.postMessage('{"event":"command","func":"' + 'playVideo' + '","args":""}', '*');
}, 300); });
...
$(document).click(function(e){
	...
	$('.mfp-wrap').hide();
	$('.top-line').show();
	$('.mfp-iframe')[0].contentWindow.postMessage('{"event":"command","func":"' + 'stopVideo' + '","args":""}', '*');
	e.stopPropagation();
	$("body").css("overflow","auto");
	$(".play").css('zIndex', '10')
	$(".mfp-wrap").css('zIndex', '15')
});
