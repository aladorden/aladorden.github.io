  ...
  'jsTwentytwenty': function() {
    ...
    $(document).ready(function() {
      ...
      function mask_wheel1(parent_div) {
        $('.img-compare .images-compare-before .mask_wheel').css('opacity', '0');
        var w_w = $(window).width();
        if (w_w >= 1160) {
          w_w = w_w
        } else {
        ...
        setTimeout(function() {
          var wheel_center_pos_left_2 = parent.find('.wheel').offset().left + 10
          console.log(wheel_center_pos_left_2)
          $('.img-compare .images-compare-before .wheel_bg').css('left', wheel_center_pos_left_2 - $('.img-compare .images-compare-before .wheel_bg').width() + $('.images-compare-before .wheel').width() - 80 + 'px');


          parent.find('.mask_wheel').css('left', wheel_center_pos_left_2 - $('.img-compare .images-compare-before .mask_wheel').width() + $('.images-compare-before .wheel').width() - 50 + 'px');
          parent.find('.mask_wheel img').css('left', (wheel_center_pos_left_2 - $('.img-compare .images-compare-before .mask_wheel').width() + $('.images-compare-before .wheel').width() - 50) * -1 + 'px');
          parent.find('.mask_wheel').css('opacity', '1');
        }, 1000)
      ...
      function mask_wheel2(parent_div) {
        ...
        $('.img-compare .images-compare-after .wheel_bg').css('right', w_w / 2 - width_center_wheel / 2 - width_wheel_bg / 2 - 30 + 'px');
        setTimeout(function() {
          parent.find('.mask_wheel').width(w + 80);
          parent.find('.mask_wheel').height(w_h);
          parent.find('.mask_wheel').css('right', pos_right_wheel_center - w - 30 + 'px');
          parent.find('.mask_wheel img').css('right', (pos_right_wheel_center - w - 30) * -1 + 'px');
        }, 100)
      }
      ...
      function move_direction() {
        ...
        container.on("move", function(e) {
          ...
          if ((catalog_show_1 !== 'true') && (catalog_show_2 !== 'true')) {
            ...
            } else if ((val >= 82) && (direction == 'right')) {
              $('.images-compare-before').attr('data-catalog', 'true');
              $('.images-compare-after').attr('data-catalog', 'false');
