(function($, Drupal) {
    var func = {
            ...
            $(document).ready(function() {
                ...
                container.on("move", function(e) {
                    ...
                    if ((catalog_show_1 !== 'true') && (catalog_show_2 !== 'true')) {
                        ...
                        if (val < 49) {
                            $('.images-compare-before canvas').removeClass('opacity');
                            $('.images-compare-after canvas').addClass('opacity');
                        } else if (val > 51) {
                            $('.images-compare-before canvas').addClass('opacity');
                            $('.images-compare-after canvas').removeClass('opacity');
                        } else {
                            $('.images-compare-before canvas').removeClass('opacity');
                            $('.images-compare-after canvas').removeClass('opacity');
                        }
        ...
        "rainTyre": function() {
            ...
            function rain_3() {
                var c = document.getElementById("rain_3");
            ...
            function rain_4() {
                ...
                var can = document.querySelector('#rain_4');
                ...
                function draw() {
                    ...
                    for (var i = 0; i < rainCount; i++) {
                        ...
                        canvas.fillStyle = '#5b597b45'; //creates the rectangles color
