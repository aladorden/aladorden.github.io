...
(function ($, undefined) {
	$.fn.prettyEmbed = function (options) {
		...
		function clickEventRunner(obj) {
			...
			obj.html('<iframe width="' + wrapperWidth + '" height="' + wrapperHeight + '" ' + fullScreenFlag + 'style="border:none;" src="//www.youtube.com/embed/' + thisVideoID + '?autoplay=0' + playerOptions + '"></iframe>')
